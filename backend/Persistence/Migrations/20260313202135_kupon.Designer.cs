...
namespace Persistence.Migrations
{
    ...
    [Migration("20260313202135_kupon")]
    partial class kupon
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Common.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e9f20612-4b09-4fdc-bef1-f4ca906bd36d"),
                            AddressLine1 = "Ahmet Yesevi, Bey Sk. No:4/B",
                            AddressName = "Gönderim Adresi",
                            AddressType = (short)4,
                            CityId = new Guid("5d0c385c-810d-4dd6-9462-259183584992"),
                            CreatedDate = new DateTime(2026, 3, 13, 23, 21, 34, 608, DateTimeKind.Local).AddTicks(8270),
                            FirstName = "Pizzacı",
                            IsDefault = true,
                            LastName = "Ahmet",
                        ...
                        new
                        {
                            Id = new Guid("1f7fb4f9-0823-40b3-be79-37f4300c756a"),
                            AddressLine1 = "Geçit Mah. 1. Begonya Sok. No: 57 Daire: 6",
                            AddressLine2 = "Oliva Sitesi B Blok",
                            AddressName = "Teslimat Adresi",
                            AddressType = (short)2,
                            CityId = new Guid("5d0c385c-810d-4dd6-9462-259183584992"),
                            CreatedDate = new DateTime(2026, 3, 13, 23, 21, 34, 609, DateTimeKind.Local).AddTicks(710),
                            FirstName = "Alıcı",
                            InvoiceType = (short)1,
                            IsDefault = true,
                            LastName = "Mehmet",
            ...
            modelBuilder.Entity("Domain.Entities.Common.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("de5ad48b-5863-4377-b781-850a21090887"),
                            ActivationKey = new Guid("f3e91787-1515-4b4a-805c-1473b298407a"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 13, 23, 21, 34, 593, DateTimeKind.Local).AddTicks(6330),
                        ...
                        new
                        {
                            Id = new Guid("d90adced-d4e6-4b53-8574-89241ba7ec49"),
                            ActivationKey = new Guid("96bcc3ec-fee0-47da-940f-9e73d1ac81ce"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 13, 23, 21, 34, 601, DateTimeKind.Local).AddTicks(5290),
                        ...
                        new
                        {
                            ...
                            ActivationKey = new Guid("1c598129-fb80-4fb2-a16e-7ec6d56da146"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 13, 23, 21, 34, 601, DateTimeKind.Local).AddTicks(5490),
            ...
            modelBuilder.Entity("Domain.Entities.Seller.Seller", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyType = (short)2,
                            CreatedDate = new DateTime(2026, 3, 13, 23, 21, 34, 602, DateTimeKind.Local).AddTicks(1160),
