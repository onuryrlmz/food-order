...
namespace Persistence.Migrations
{
    ...
    [Migration("20260313204837_OrderCouponFields")]
    partial class OrderCouponFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Common.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("728ab7a7-3cfb-45ad-a920-a0bbe5719f15"),
                            AddressLine1 = "Ahmet Yesevi, Bey Sk. No:4/B",
                            AddressName = "Gönderim Adresi",
                            AddressType = (short)4,
                            CityId = new Guid("5d0c385c-810d-4dd6-9462-259183584992"),
                            CreatedDate = new DateTime(2026, 3, 13, 23, 48, 36, 557, DateTimeKind.Local).AddTicks(2420),
                            FirstName = "Pizzacı",
                            IsDefault = true,
                            LastName = "Ahmet",
                        ...
                        new
                        {
                            Id = new Guid("94b5afdf-edbc-4a0c-81f3-dba0f3afbab4"),
                            AddressLine1 = "Geçit Mah. 1. Begonya Sok. No: 57 Daire: 6",
                            AddressLine2 = "Oliva Sitesi B Blok",
                            AddressName = "Teslimat Adresi",
                            AddressType = (short)2,
                            CityId = new Guid("5d0c385c-810d-4dd6-9462-259183584992"),
                            CreatedDate = new DateTime(2026, 3, 13, 23, 48, 36, 557, DateTimeKind.Local).AddTicks(5210),
                            FirstName = "Alıcı",
                            InvoiceType = (short)1,
                            IsDefault = true,
                            LastName = "Mehmet",
            ...
            modelBuilder.Entity("Domain.Entities.Common.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0869777d-0e11-4433-9c32-d042efeb3f23"),
                            ActivationKey = new Guid("7822052b-9cf7-4562-b08c-b1a9bb3a7dfc"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 13, 23, 48, 36, 541, DateTimeKind.Local).AddTicks(7210),
                        ...
                        new
                        {
                            Id = new Guid("d73b23d1-e497-4c28-9df6-335d2058fb18"),
                            ActivationKey = new Guid("bb3e53b8-3afc-479c-be87-7b0f1ed17005"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 13, 23, 48, 36, 549, DateTimeKind.Local).AddTicks(4040),
                        ...
                        new
                        {
                            ...
                            ActivationKey = new Guid("53353295-ddfc-4430-a84e-0bf3afa970ce"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 13, 23, 48, 36, 549, DateTimeKind.Local).AddTicks(4250),
            ...
            modelBuilder.Entity("Domain.Entities.Seller.Seller", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyType = (short)2,
                            CreatedDate = new DateTime(2026, 3, 13, 23, 48, 36, 550, DateTimeKind.Local).AddTicks(230),
