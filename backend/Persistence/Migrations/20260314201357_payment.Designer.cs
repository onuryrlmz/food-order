...
namespace Persistence.Migrations
{
    ...
    [Migration("20260314201357_payment")]
            ...
            modelBuilder.Entity("Domain.Entities.Common.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4f1dde32-3dbc-4369-9d7d-01e64689612d"),
                            AddressLine1 = "Ahmet Yesevi, Bey Sk. No:4/B",
                            AddressName = "Gönderim Adresi",
                            AddressType = (short)4,
                            CityId = new Guid("5d0c385c-810d-4dd6-9462-259183584992"),
                            CreatedDate = new DateTime(2026, 3, 14, 23, 13, 56, 409, DateTimeKind.Local).AddTicks(6280),
                            FirstName = "Pizzacı",
                            IsDefault = true,
                            LastName = "Ahmet",
                        ...
                        new
                        {
                            Id = new Guid("66bb762a-45c4-483d-9980-dd09d3ccb32f"),
                            AddressLine1 = "Geçit Mah. 1. Begonya Sok. No: 57 Daire: 6",
                            AddressLine2 = "Oliva Sitesi B Blok",
                            AddressName = "Teslimat Adresi",
                            AddressType = (short)2,
                            CityId = new Guid("5d0c385c-810d-4dd6-9462-259183584992"),
                            CreatedDate = new DateTime(2026, 3, 14, 23, 13, 56, 409, DateTimeKind.Local).AddTicks(9090),
                            FirstName = "Alıcı",
                            InvoiceType = (short)1,
                            IsDefault = true,
                            LastName = "Mehmet",
            ...
            modelBuilder.Entity("Domain.Entities.Common.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3f38b8ff-dd6d-4a4a-8a8d-f357893035f0"),
                            ActivationKey = new Guid("ea4d6aa1-376d-4bad-bcb9-00ccacb0ef39"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 14, 23, 13, 56, 394, DateTimeKind.Local).AddTicks(1860),
                        ...
                        new
                        {
                            Id = new Guid("89577d5e-ea51-45cc-ab71-cb38c69d8e84"),
                            ActivationKey = new Guid("a134c8e6-e398-4467-8d46-1294e5b6da6d"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 14, 23, 13, 56, 401, DateTimeKind.Local).AddTicks(5940),
                        ...
                        new
                        {
                            ...
                            ActivationKey = new Guid("42c2f1c5-2a39-4257-8511-bb36e816cc9d"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 14, 23, 13, 56, 401, DateTimeKind.Local).AddTicks(6160),
            ...
            modelBuilder.Entity("Domain.Entities.Seller.Seller", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyType = (short)2,
                            CreatedDate = new DateTime(2026, 3, 14, 23, 13, 56, 402, DateTimeKind.Local).AddTicks(2000),
