...
namespace Persistence.Migrations
{
    ...
    [Migration("20260314210804_orderItem")]
            ...
            modelBuilder.Entity("Domain.Entities.Common.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f76bf318-7350-4e5d-8bae-f12fbd835fd3"),
                            AddressLine1 = "Ahmet Yesevi, Bey Sk. No:4/B",
                            AddressName = "Gönderim Adresi",
                            AddressType = (short)4,
                            CityId = new Guid("5d0c385c-810d-4dd6-9462-259183584992"),
                            CreatedDate = new DateTime(2026, 3, 15, 0, 8, 3, 772, DateTimeKind.Local).AddTicks(4300),
                            FirstName = "Pizzacı",
                            IsDefault = true,
                            LastName = "Ahmet",
                        ...
                        new
                        {
                            Id = new Guid("d6012e04-9070-4841-b816-f798d61a9616"),
                            AddressLine1 = "Geçit Mah. 1. Begonya Sok. No: 57 Daire: 6",
                            AddressLine2 = "Oliva Sitesi B Blok",
                            AddressName = "Teslimat Adresi",
                            AddressType = (short)2,
                            CityId = new Guid("5d0c385c-810d-4dd6-9462-259183584992"),
                            CreatedDate = new DateTime(2026, 3, 15, 0, 8, 3, 772, DateTimeKind.Local).AddTicks(6490),
                            FirstName = "Alıcı",
                            InvoiceType = (short)1,
                            IsDefault = true,
                            LastName = "Mehmet",
            ...
            modelBuilder.Entity("Domain.Entities.Common.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ea162dc7-8961-45b8-a57e-bb9e3a13c9eb"),
                            ActivationKey = new Guid("b5477e9b-aa1b-4484-96a3-54a3a110183d"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 15, 0, 8, 3, 759, DateTimeKind.Local).AddTicks(5450),
                        ...
                        new
                        {
                            Id = new Guid("ef0a2700-8551-4159-bdae-2e4525f5c7f0"),
                            ActivationKey = new Guid("7b0349cd-d114-4a04-b4a3-a082fcb573bc"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 15, 0, 8, 3, 765, DateTimeKind.Local).AddTicks(8900),
                        ...
                        new
                        {
                            ...
                            ActivationKey = new Guid("45ea4212-6c78-41f2-8d18-18376dbda200"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 15, 0, 8, 3, 765, DateTimeKind.Local).AddTicks(9070),
            ...
            modelBuilder.Entity("Domain.Entities.Seller.Seller", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyType = (short)2,
                            CreatedDate = new DateTime(2026, 3, 15, 0, 8, 3, 766, DateTimeKind.Local).AddTicks(3890),
