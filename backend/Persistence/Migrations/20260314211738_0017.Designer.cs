            ...
            modelBuilder.Entity("Domain.Entities.Common.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("76b9e4c4-806e-4571-9087-48d619b0a257"),
                            AddressLine1 = "Ahmet Yesevi, Bey Sk. No:4/B",
                            AddressName = "Gönderim Adresi",
                            AddressType = (short)4,
                            CityId = new Guid("5d0c385c-810d-4dd6-9462-259183584992"),
                            CreatedDate = new DateTime(2026, 3, 15, 0, 17, 38, 261, DateTimeKind.Local).AddTicks(1080),
                            FirstName = "Pizzacı",
                            IsDefault = true,
                            LastName = "Ahmet",
                        ...
                        new
                        {
                            Id = new Guid("f5e3aa49-6151-440f-a727-50fc383aba6d"),
                            AddressLine1 = "Geçit Mah. 1. Begonya Sok. No: 57 Daire: 6",
                            AddressLine2 = "Oliva Sitesi B Blok",
                            AddressName = "Teslimat Adresi",
                            AddressType = (short)2,
                            CityId = new Guid("5d0c385c-810d-4dd6-9462-259183584992"),
                            CreatedDate = new DateTime(2026, 3, 15, 0, 17, 38, 261, DateTimeKind.Local).AddTicks(3960),
                            FirstName = "Alıcı",
                            InvoiceType = (short)1,
                            IsDefault = true,
                            LastName = "Mehmet",
            ...
            modelBuilder.Entity("Domain.Entities.Common.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e0f1f845-ca76-4e9e-a345-7dae183c8b3a"),
                            ActivationKey = new Guid("4f292a87-0406-4245-8f9d-bd9106fb7d71"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 15, 0, 17, 38, 187, DateTimeKind.Local).AddTicks(5230),
                        ...
                        new
                        {
                            Id = new Guid("cd25b2a0-6854-48a4-b505-623635b5c587"),
                            ActivationKey = new Guid("bf487616-9267-425e-8066-ab710766f68a"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 15, 0, 17, 38, 245, DateTimeKind.Local).AddTicks(950),
                        ...
                        new
                        {
                            ...
                            ActivationKey = new Guid("6c88cdc4-a3b3-41bc-b957-a67773555188"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 15, 0, 17, 38, 245, DateTimeKind.Local).AddTicks(1180),
            ...
            modelBuilder.Entity("Domain.Entities.Seller.Seller", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyType = (short)2,
                            CreatedDate = new DateTime(2026, 3, 15, 0, 17, 38, 245, DateTimeKind.Local).AddTicks(7310),
