            ...
            modelBuilder.Entity("Domain.Entities.Common.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3807c93f-b0e0-4f80-9cc7-0518d040bdb2"),
                            AddressLine1 = "Ahmet Yesevi, Bey Sk. No:4/B",
                            AddressName = "Gönderim Adresi",
                            AddressType = (short)4,
                            CityId = new Guid("5d0c385c-810d-4dd6-9462-259183584992"),
                            CreatedDate = new DateTime(2026, 3, 15, 0, 43, 29, 39, DateTimeKind.Local).AddTicks(560),
                            FirstName = "Pizzacı",
                            IsDefault = true,
                            LastName = "Ahmet",
                        ...
                        new
                        {
                            Id = new Guid("fed9e08c-52d7-4f6a-8eea-a6f7a9921396"),
                            AddressLine1 = "Geçit Mah. 1. Begonya Sok. No: 57 Daire: 6",
                            AddressLine2 = "Oliva Sitesi B Blok",
                            AddressName = "Teslimat Adresi",
                            AddressType = (short)2,
                            CityId = new Guid("5d0c385c-810d-4dd6-9462-259183584992"),
                            CreatedDate = new DateTime(2026, 3, 15, 0, 43, 29, 39, DateTimeKind.Local).AddTicks(3040),
                            FirstName = "Alıcı",
                            InvoiceType = (short)1,
                            IsDefault = true,
                            LastName = "Mehmet",
            ...
            modelBuilder.Entity("Domain.Entities.Common.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c6824012-2e9a-476c-b472-08c7caab16bc"),
                            ActivationKey = new Guid("8bec984b-9d90-4134-b545-d215924751ee"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 15, 0, 43, 29, 23, DateTimeKind.Local).AddTicks(4920),
                        ...
                        new
                        {
                            Id = new Guid("e2035b44-07f0-4de2-bd60-6ae3f684741c"),
                            ActivationKey = new Guid("f6ee3eff-a367-4141-b48c-e79f1e239e47"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 15, 0, 43, 29, 30, DateTimeKind.Local).AddTicks(9680),
                        ...
                        new
                        {
                            ...
                            ActivationKey = new Guid("c1874e60-0191-456f-aaf6-81c80b854431"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 15, 0, 43, 29, 30, DateTimeKind.Local).AddTicks(9890),
            ...
            modelBuilder.Entity("Domain.Entities.Seller.Seller", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyType = (short)2,
                            CreatedDate = new DateTime(2026, 3, 15, 0, 43, 29, 31, DateTimeKind.Local).AddTicks(8780),
