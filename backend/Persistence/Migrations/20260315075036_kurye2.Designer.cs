...
namespace Persistence.Migrations
{
    ...
    [Migration("20260315075036_kurye2")]
    partial class kurye2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Common.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("57fbb27d-374f-4e5a-98ff-78d645a56409"),
                            AddressLine1 = "Ahmet Yesevi, Bey Sk. No:4/B",
                            AddressName = "Gönderim Adresi",
                            AddressType = (short)4,
                            CityId = new Guid("5d0c385c-810d-4dd6-9462-259183584992"),
                            CreatedDate = new DateTime(2026, 3, 15, 10, 50, 34, 71, DateTimeKind.Local).AddTicks(7130),
                            FirstName = "Pizzacı",
                            IsDefault = true,
                            LastName = "Ahmet",
                        ...
                        new
                        {
                            Id = new Guid("a058d992-1eb8-4f31-9620-40ee833ae4fb"),
                            AddressLine1 = "Geçit Mah. 1. Begonya Sok. No: 57 Daire: 6",
                            AddressLine2 = "Oliva Sitesi B Blok",
                            AddressName = "Teslimat Adresi",
                            AddressType = (short)2,
                            CityId = new Guid("5d0c385c-810d-4dd6-9462-259183584992"),
                            CreatedDate = new DateTime(2026, 3, 15, 10, 50, 34, 71, DateTimeKind.Local).AddTicks(9790),
                            FirstName = "Alıcı",
                            InvoiceType = (short)1,
                            IsDefault = true,
                            LastName = "Mehmet",
            ...
            modelBuilder.Entity("Domain.Entities.Common.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9639d397-3ff2-404f-b326-917e83f480af"),
                            ActivationKey = new Guid("9934398f-1788-4e13-904d-c2d86a88bb4c"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 15, 10, 50, 34, 44, DateTimeKind.Local).AddTicks(8680),
                        ...
                        new
                        {
                            Id = new Guid("90321f3a-c596-4b54-ab66-2e31ef565642"),
                            ActivationKey = new Guid("2d224f76-0314-462e-9f13-1d431329bda8"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 15, 10, 50, 34, 63, DateTimeKind.Local).AddTicks(4760),
                        ...
                        new
                        {
                            ...
                            ActivationKey = new Guid("74f25a48-5489-49e6-a617-c00fa35e47ad"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 15, 10, 50, 34, 63, DateTimeKind.Local).AddTicks(4980),
            ...
            modelBuilder.Entity("Domain.Entities.Seller.Seller", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyType = (short)2,
                            CreatedDate = new DateTime(2026, 3, 15, 10, 50, 34, 64, DateTimeKind.Local).AddTicks(2100),
            ...
            modelBuilder.Entity("Domain.Entities.Courier.Courier", b =>
                {
                    ...
                    b.Navigation("RestaurantCouriers");
                });
