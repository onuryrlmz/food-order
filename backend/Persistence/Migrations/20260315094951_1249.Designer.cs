            ...
            modelBuilder.Entity("Domain.Entities.Common.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a497f528-192e-4911-ac45-f97a2276adb4"),
                            AddressLine1 = "Ahmet Yesevi, Bey Sk. No:4/B",
                            AddressName = "Gönderim Adresi",
                            AddressType = (short)4,
                            CityId = new Guid("5d0c385c-810d-4dd6-9462-259183584992"),
                            CreatedDate = new DateTime(2026, 3, 15, 12, 49, 51, 176, DateTimeKind.Local).AddTicks(9340),
                            FirstName = "Pizzacı",
                            IsDefault = true,
                            LastName = "Ahmet",
                        ...
                        new
                        {
                            Id = new Guid("52c04c29-db2b-467e-8442-589fd4054997"),
                            AddressLine1 = "Geçit Mah. 1. Begonya Sok. No: 57 Daire: 6",
                            AddressLine2 = "Oliva Sitesi B Blok",
                            AddressName = "Teslimat Adresi",
                            AddressType = (short)2,
                            CityId = new Guid("5d0c385c-810d-4dd6-9462-259183584992"),
                            CreatedDate = new DateTime(2026, 3, 15, 12, 49, 51, 177, DateTimeKind.Local).AddTicks(2200),
                            FirstName = "Alıcı",
                            InvoiceType = (short)1,
                            IsDefault = true,
                            LastName = "Mehmet",
            ...
            modelBuilder.Entity("Domain.Entities.Common.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5631f1af-b7aa-4677-bb04-87f9f66e0839"),
                            ActivationKey = new Guid("a66cb2fd-53fe-4e81-bffe-d865abf8c9cf"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 15, 12, 49, 51, 161, DateTimeKind.Local).AddTicks(4530),
                        ...
                        new
                        {
                            Id = new Guid("c57f7f06-8406-439a-af4b-cafb9828b69a"),
                            ActivationKey = new Guid("8a205dab-dcd5-49b4-8141-709eff496d15"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 15, 12, 49, 51, 168, DateTimeKind.Local).AddTicks(8270),
                        ...
                        new
                        {
                            ...
                            ActivationKey = new Guid("2ed0b8ba-9649-4059-a318-c17138132250"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 15, 12, 49, 51, 168, DateTimeKind.Local).AddTicks(8510),
            ...
            modelBuilder.Entity("Domain.Entities.Seller.Seller", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyType = (short)2,
                            CreatedDate = new DateTime(2026, 3, 15, 12, 49, 51, 169, DateTimeKind.Local).AddTicks(4710),
