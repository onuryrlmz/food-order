...
namespace Persistence.Migrations
{
    ...
    [Migration("20260315140925_FixRestaurantCourierFKToUser")]
    partial class FixRestaurantCourierFKToUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Common.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("52129533-b6fb-4fa9-bc25-610d7b46dcac"),
                            AddressLine1 = "Ahmet Yesevi, Bey Sk. No:4/B",
                            AddressName = "Gönderim Adresi",
                            AddressType = (short)4,
                            CityId = new Guid("5d0c385c-810d-4dd6-9462-259183584992"),
                            CreatedDate = new DateTime(2026, 3, 15, 17, 9, 24, 816, DateTimeKind.Local).AddTicks(6990),
                            FirstName = "Pizzacı",
                            IsDefault = true,
                            LastName = "Ahmet",
                        ...
                        new
                        {
                            Id = new Guid("71628373-e06b-4550-a8e6-ddb827dce1f8"),
                            AddressLine1 = "Geçit Mah. 1. Begonya Sok. No: 57 Daire: 6",
                            AddressLine2 = "Oliva Sitesi B Blok",
                            AddressName = "Teslimat Adresi",
                            AddressType = (short)2,
                            CityId = new Guid("5d0c385c-810d-4dd6-9462-259183584992"),
                            CreatedDate = new DateTime(2026, 3, 15, 17, 9, 24, 816, DateTimeKind.Local).AddTicks(9810),
                            FirstName = "Alıcı",
                            InvoiceType = (short)1,
                            IsDefault = true,
                            LastName = "Mehmet",
            ...
            modelBuilder.Entity("Domain.Entities.Common.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b0c7501f-03eb-4950-be4b-2a92053d1a1a"),
                            ActivationKey = new Guid("73dffe97-8546-45b7-a43e-b15e17c83bf4"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 15, 17, 9, 24, 801, DateTimeKind.Local).AddTicks(2880),
                        ...
                        new
                        {
                            Id = new Guid("edd03c77-a2c0-46e7-ac6b-f1c820af579f"),
                            ActivationKey = new Guid("e470e854-a2ff-43c4-ac9f-9b7c75688736"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 15, 17, 9, 24, 808, DateTimeKind.Local).AddTicks(7780),
                        ...
                        new
                        {
                            ...
                            ActivationKey = new Guid("04a70ed6-d0a1-4685-b972-92ec872262e3"),
                            BirthDate = new DateTime(1994, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedDate = new DateTime(2026, 3, 15, 17, 9, 24, 808, DateTimeKind.Local).AddTicks(7990),
            ...
            modelBuilder.Entity("Domain.Entities.Courier.RestaurantCourier", b =>
                {
                    ...
                    b.HasIndex("RestaurantId", "CourierId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entities.Seller.Seller", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyType = (short)2,
                            CreatedDate = new DateTime(2026, 3, 15, 17, 9, 24, 809, DateTimeKind.Local).AddTicks(4000),
