...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    ]).then(([plansRes, subsRes, sellersRes, restaurantsRes, ordersRes, usersRes, analyticsRes, trendsRes]) => {
    ...
    <AdminLayout title="Dashboard">
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl p-5 text-white">
          <h3 className="font-semibold text-lg">Abonelik Kontrolu</h3>
          <p className="text-orange-100 text-sm mt-1">
            Suresi dolmus abonelikleri kontrol et ve restoranlari otomatik pasife al.
          </p>
          <a
            href="/subscriptions"
