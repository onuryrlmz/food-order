          ...
          {[1, 2, 3].map(s => (
            <div
              ...
              className={`h-2 rounded-full transition-all ${
                s === step ? 'w-8 bg-orange-500' : s < step ? 'w-8 bg-orange-700' : 'w-8 bg-slate-700'
              }`}
            />
          ))}
        </div>
            ...
            <form onSubmit={handleSendCode} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-orange-400 focus:border-orange-400"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-orange-500 hover:bg-orange-600 text-white font-semibold py-2.5 rounded-lg text-sm disabled:opacity-60 flex items-center justify-center gap-2"
              >
            ...
            <form onSubmit={handleVerifyCode} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  placeholder="000000"
                  maxLength={6}
                  className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm text-center text-2xl font-bold tracking-widest outline-none focus:ring-2 focus:ring-orange-400 focus:border-orange-400"
                />
              </div>
